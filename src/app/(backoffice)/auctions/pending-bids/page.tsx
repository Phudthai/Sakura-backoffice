...
export default function PendingBidsPage() {
  ...
  const saveNote = async () => {
    ...
    setNoteSaving(true)
    try {
      const res = await fetch(`${API_BACKOFFICE_PREFIX}/auction-requests/${editingNoteArId}/note`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-sakura-900 tracking-tight">การประมูลที่รออนุมัติ</h1>
        </div>
